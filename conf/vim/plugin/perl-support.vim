...
"
  " ==========  Linux/Unix  ======================================================
	let s:Perl_LocalTemplateFile		= g:plugin_ldir.'perl-support/templates/Templates'
	let g:Perl_Installation						= 'local'
	let s:Perl_LocalTemplateDir			= fnamemodify( s:Perl_LocalTemplateFile, ":p:h" ).'/'
	let s:Perl_CodeSnippets  				= g:plugin_ldir.'perl-support/codesnippets/'
	let s:escfilename   = ' \%#[]'
...
if !exists("g:Perl_Dictionary_File")
  let g:Perl_Dictionary_File       = g:plugin_ldir.'perl-support/wordlists/perl.list'
endif
"
"
...
let s:Perl_PerlModuleList        = g:plugin_ldir.'perl-support/modules/perl-modules.list'
...
"
let s:Perl_Wrapper                 = g:plugin_ldir.'perl-support/scripts/wrapper.sh'
let s:Perl_EfmPerl                 = g:plugin_ldir.'perl-support/scripts/efm_perl.pl'
let s:Perl_PerlModuleListGenerator = g:plugin_ldir.'perl-support/scripts/pmdesc3.pl'
"
"------------------------------------------------------------------------------
"
