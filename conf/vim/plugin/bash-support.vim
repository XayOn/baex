...
"       Revision:  $Id: bash-support,v 1.81 2010/12/05 11:10:47 mehner Exp $
"
"------------------------------------------------------------------------------
"
...
"
if v:version < 700
  echohl WarningMsg | echo 'plugin bash-support needs Vim version >= 7'| echohl None
endif
"
"#################################################################################
"
...
if	s:MSWIN
  " ==========  MS Windows  ======================================================
	...
	if match( s:sourced_script_file, escape( s:vimfiles, ' \' ) ) == 0
		...
		let g:plugin_ldir								= $VIM.'/vimfiles/'
		let s:BASH_GlobalTemplateFile   = g:plugin_ldir.'bash-support/templates/Templates'
		let s:BASH_GlobalTemplateDir    = fnamemodify( s:BASH_GlobalTemplateFile, ":p:h" ).'/'
		" user installation assumed
		" let g:plugin_ldir  							= $HOME.'/vimfiles/'
	endif
	"
...
"		let s:installation	= 'system'
		...
		" user installation assumed
    "if !g:plugin_ldir
  	"	let g:plugin_ldir  	= g:plugin_ldir.'/'
    "endif
	end
	"
	let s:BASH_LocalTemplateFile		= g:plugin_ldir.'/bash-support/templates/Templates'
	let s:BASH_LocalTemplateDir			= fnamemodify( s:BASH_LocalTemplateFile, ":p:h" ).'/'
	let s:BASH_CodeSnippets  				= g:plugin_ldir.'/bash-support/codesnippets/'
...
if !exists("g:BASH_Dictionary_File")
	let g:BASH_Dictionary_File     = g:plugin_ldir.'bash-support/wordlists/bash.list'
endif
"
...
let s:BASH_Wrapper                 = g:plugin_ldir.'bash-support/scripts/wrapper.sh'
"
...
function! BASH_HelpBASHsupport ()
	try
		...
		exe ':helptags '.g:plugin_ldir.'doc'
		:help bashsupport
	endtry
